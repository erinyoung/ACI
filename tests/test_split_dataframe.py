...
def test_split_dataframe_normal():
    ...
    with mock.patch("aci.utils.split_dataframe.group_create") as mock_group_create, \
         mock.patch("aci.utils.split_dataframe.group_mean") as mock_group_mean:

        mock_group_create.return_value = pd.DataFrame({
            "pos": ["0-499", "500-999", "1000-1499"],
            "group": [0, 1, 2]
        })
